...
contract TestGasPriceFeesHook is Test, Deployers {
    ...
    function setUp() public {
        ...
        // manager is from the Deployers.sol contract
    ...
    function test_feeUpdatesWithGasPrice()
        public
    {
        ...
        /**
         * @dev performing an exact input swap
         * @param zeroForOne - direction of the swap (token0 -> token1)
         * @param amountSpecified - amount of currency to swap (-0.00001 ether, user have pay -0.00001 ether)
         * @param sqrtPriceLimitX96 - sqrt price limit of the swap. set it to minimum price "I don't care about slippage, keep swapping my tokens even if the price crashes all the way to the bottom."
         */
