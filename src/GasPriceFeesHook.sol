...
contract GasPriceFeesHook is BaseHook {
        ...
        returns (bytes4, BeforeSwapDelta, uint24)
    {
        ...
        // using the `OVERRIDE_FEE_FLAG` from `LPFeeLibrary`
        // to set the second-highest bit of the fee to signal that the
        // stored LP fee should be overridden in this swap
    ...
    /// @notice Returns the fee for the current transaction based on the moving average gas price
